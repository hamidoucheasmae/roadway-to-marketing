...
<div id="portfolio-ajax-single" class="clearfix">
	...
	<div id="portfolio-ajax-title" style="position: relative;">
		<h2>Single Item with Slider Gallery</h2>
	...
	<div class="row col-mb-50">
			...
			<div class="fslider" data-arrows="false" data-thumbs="true" data-animation="fade">
				<div class="flexslider">
					<div class="slider-wrap">
						<div class="slide" data-thumb="images/portfolio/single/slider-thumbs/1.jpg"><a href="#"><img src="images/portfolio/single/1.jpg" alt="Image"></a></div>
						<div class="slide" data-thumb="images/portfolio/single/slider-thumbs/7.jpg"><a href="#"><img src="images/portfolio/single/7.jpg" alt="Image"></a></div>
						<div class="slide" data-thumb="images/portfolio/single/slider-thumbs/10.jpg"><a href="#"><img src="images/portfolio/single/10.jpg" alt="Image"></a></div>
					</div>
				</div>
			</div>
		...
		============================================= -->
		<div class="col-md-5 portfolio-single-content">
